...
const questions = [{
    ...
    {
        question: 'Какой язык после JS я буду изучать?',//мои
        options: [
            'Python',
            'Японский',
            'Язык улюлюканья',
...
const checkAnswer = el => {
    if (el.target.dataset.id == questions[indexOfQuestion].rightAnswer) {
        ...
        score++;
		alert('Верный ответ...');//моя строка2
    } else {
		alert('Неверный ответ...');//моя строка1
